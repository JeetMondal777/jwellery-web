  ...
  return (
    <div className="w-96 bg-gradient-to-br from-white to-gray-50 p-8 rounded-2xl shadow-xl relative overflow-hidden border border-gray-100">
      ...
      <div className="grid grid-cols-3 gap-4 mb-2 relative z-10">
        <button className="group cursor-pointer bg-gray-50 hover:bg-gray-100 p-4 rounded-xl transition-all duration-300 shadow-sm">
          <div className="flex flex-col items-center space-y-2">
            <div
            onClick={() => navigate('/order')}
            className="p-3 bg-gradient-to-br from-rose-400 to-yellow-400 rounded-lg">
      ...
      <div className="border-t border-gray-200 pt-6 relative z-10">
        <div className="flex justify-between items-center">
          <div className="text-sm">
            ...
            <p className="text-gray-700 font-medium">{user.createdAt.slice(0, 10)}</p>
          </div>
          <button 
            onClick={handleLogout}
            className="flex items-center space-x-2 bg-rose-100 hover:bg-rose-200 px-4 py-2 rounded-lg transition-colors"
          >

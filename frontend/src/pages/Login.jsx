...
const LoginForm = ({ onSwitchToRegister }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Only show loading toast if not already logged in
  ...
  return (
    <div className="p-8 flex flex-col justify-center">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="email" className="block text-sm font-medium text-rose-400">
            Email
          </label>
          <input
            id="email"
        ...
        <div>
          <label htmlFor="password" className="block text-sm font-medium text-rose-400">
            Password
          </label>
        ...
        <div>
          <button
            ...
            className="w-full cursor-pointer py-2 px-4 bg-rose-300 text-white font-semibold rounded-lg hover:bg-rose-400 hover:scale-105 transition-all duration-300 focus:outline-none focus:ring-2 mb-2 focus:ring-rose-300"
          >
            Log In As Guest
          </button>
          <button
            type="submit"
            className="cursor-pointer w-full py-2 px-4 bg-rose-300 text-white font-semibold rounded-lg hover:bg-rose-400 hover:scale-105 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-rose-300"
          >
            Log In
          </button>

          <p className="text-rose-400 mt-2 mb-20 text-center text-[12px]">
            Don’t have an account?{' '}
            <span
              className="inline-block cursor-pointer expanding-underline text-rose-500 font-semibold"
